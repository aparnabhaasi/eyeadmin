          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row gy-4">
                ...
                <div class="card">
                    <div class="text-end p-3"><a href="add-computerglass.php" class="btn btn-success">Add new <i class="fa fa-plus"></i></a></div>

                      <h3 class="card-header text-center"><strong>Computer Glassess</strong></h3>
                  <hr>
                  ...
                  <div class="table-responsive text-nowrap">
                    <table class="table table-hover">
                      ...
                      <tbody class="table-border-bottom-0">
                        <?php
                        $q="select * from product where product='computerglass'";
                        $res=select($q);
                        $i=1;
                        foreach($res as $row)
                        {?>
                        <tr>
                            ...
                            <td><img src="uploads/products/<?php echo $row['product_image1'];?>" alt="" width="100"></td>
