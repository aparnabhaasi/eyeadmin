                ...
                <div class="card">
                  ...
                  <div class="table-responsive text-nowrap">
                    <table class="table table-hover">
                      ...
                      <?php
$qr="SELECT * FROM tbl_childcart INNER JOIN tbl_mastcart USING(mastcart_id) INNER JOIN users ON users.user_id = tbl_mastcart.user_id INNER JOIN tbl_order USING(mastcart_id) INNER JOIN user_address USING(user_address_id) where status='delivered';
";
$hh=select($qr);
$i=1;
foreach($hh as $row){
...
?>
                        <tr>
                          ...
                          <td><span class="badge rounded-pill bg-label-success me-1">Delivered</span></td>                        </tr>
</tr>
                      </tbody>
<?php } ?>
                    </table>
