...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO product (product, category, frame_type, product_name, actual_price, selling_price, product_image, product_image2, product_image3, product_image4,details,information,description,date) 
            VALUES ('eyeglass', '$category', '$frameType', '$productName', '$actualPrice', '$sellingPrice', '$uploadedFiles[0]', '$uploadedFiles[1]', '$uploadedFiles[2]', '$uploadedFiles[3]', '$details', '$information','$description',now())";

    // Execute the query using your established database connection ($conn)
    if ($conn->query($sql) === TRUE) {
      return redirect('product-eyeglass.php');
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row gy-4 justify-content-center">
                    ...
                    <div class="col-xl-6 mt-5">
                        <!-- HTML5 Inputs -->
                        <div class="card mb-4">
                          <h3 class="card-header text-center">Add New Eye Glass</h3>
                          <div class="card-body">
