          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row gy-4">
                ...
                <div class="card">
                    <div class="text-end p-3"><a href="add-eyeglass.php" class="btn btn-success">Add new <i class="fa fa-plus"></i></a></div>

                      <h3 class="card-header text-center"><strong>Eye Glassess</strong></h3>
                  <hr>
                  ...
                  <div class="table-responsive text-nowrap">
                    <table class="table table-hover">
                      ...
                      <?php
                        $q="select * from product where product='eyeglass'";
                        $res=select($q);
                        $i=1;
                        foreach($res as $row)
                        {?>
