          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row gy-4">
                ...
                <div class="card">
                    <div class="text-end p-3"><a href="add-contactlense.php" class="btn btn-success">Add new <i class="fa fa-plus"></i></a></div>

                  <h3 class="card-header text-center"><strong>Contact Lenses</strong></h3><hr>
                    ...
                    <table class="table table-hover">
                      ...
                      <?php
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['selling_name'];?></td>
                            <td><?php echo $row['disposability'];?></td>
                            <td><img src="a<?php echo $row['product_image'];?>" alt="" width="100"></td>
