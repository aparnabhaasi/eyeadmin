...
if(isset($_POST['ship'])){
 extract($_POST);
 $oid= $_POST['oid'];
  $q= "update tbl_order set status='delivered' where order_id='$oid'";
  update($q);
  return redirect('delivered-orders.php');
}
?>
                ...
                <div class="card">
                  ...
                  <div class="table-responsive text-nowrap">
                    <table class="table table-hover">
                      ...
                      <?php
$qr="SELECT * FROM tbl_childcart INNER JOIN tbl_mastcart USING(mastcart_id) INNER JOIN users ON users.user_id = tbl_mastcart.user_id INNER JOIN tbl_order USING(mastcart_id) INNER JOIN user_address USING(user_address_id) where status='shipped';
";
$hh=select($qr);
$i=1;
foreach($hh as $row){
...
?>
                    ...
                    <td><button type="submit" name="ship" class="btn btn-primary">Deliver</button></td>
                </form>
                        </tr>
                        <?php } ?>
