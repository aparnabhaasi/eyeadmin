                    ...
                    <div class="card h-100">
                        <div class="row p-4">
                            <div class="card-body col-8">
                                <h3 class="mb-2">New Orders</h3>
                                <div class="d-flex flex-wrap align-items-center mb-2 pb-1">
                                    <h5 5 class="mb-0 me-2 fw-bold text-danger">862</h5>
                                </div>
                                <small>Manage Products</small>
                            </div>
                            <div class="avatar col-4 text-center " >
                              <div class="avatar-initial bg-danger p-3">
                ...
                <div class="col-sm-4">
                  <a href="shipped-orders.php">
                    <div class="card h-100">
                        <div class="row p-4">
                            <div class="card-body col-8">
                                <h3 class="mb-2">Shipped Orders</h3>
                                <div class="d-flex flex-wrap align-items-center mb-2 pb-1">
                                    <h5 5 class="mb-0 me-2 fw-bold text-danger">862</h5>
                                </div>
                                <small>Manage Products</small>
                            ...
                            <div class="avatar col-4 text-center " >
                              <div class="avatar-initial bg-warning p-3">
                ...
                <div class="col-sm-4">
                  <a href="delivered-orders.php">
                    <div class="card h-100">
                        <div class="row p-4">
                            <div class="card-body col-8">
                                <h3 class="mb-2">Delivered Orders</h3>
                                <div class="d-flex flex-wrap align-items-center mb-2 pb-1">
                                    <h5 5 class="mb-0 me-2 fw-bold text-danger">862</h5>
                                </div>
                                <small>Manage Products</small>
                            ...
                            <div class="avatar col-4 text-center " >
                              <div class="avatar-initial bg-success p-3">
                  ...
                  <a href="products.php">
                    <div class="card h-100">
                        <div class="row p-4">
                            ...
                            <div class="avatar col-4 text-center " >
                              <div class="avatar-initial bg-primary p-3">
                  ...
                  <a href="users.php">
                    <div class="card h-100">
                        <div class="row p-4">
                            ...
                            <div class="avatar col-4 text-center " >
                              <div class="avatar-initial bg-dark p-3">
                  ...
                  <a href="offers.php">
                    <div class="card h-100">
                        <div class="row p-4">
                            ...
                            <div class="avatar col-4 text-center " >
                              <div class="avatar-initial bg-secondary p-3">
